...
const String ENDPOINT_GET_POPULAR = "/3/movie/popular"; // banner
const String ENDPOINT_GET_TOP_RATED = "/3/movie/top_rated"; // showcase
const String ENDPOINT_GET_GENRES = "/3/genre/movie/list"; // genre
const String ENDPOINT_GET_MOVIES_BY_GENRES = "/3/discover/movie";
const String ENDPOINT_GET_ACTOR = "/3/person/popular";
...
//// Constant Values
const String API_KEY = "43eddf07a106e6bc2784f2902835d35c";
